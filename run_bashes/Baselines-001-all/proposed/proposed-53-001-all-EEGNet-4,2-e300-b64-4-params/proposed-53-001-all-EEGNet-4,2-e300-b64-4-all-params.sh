...
for conf in "${confidence_thresholds[@]}"; do
    for ent in "${entropy_thresholds[@]}"; do
        ...
        python3 $progarm_path \
          ...
          --stride "8" \
          --batch_size_online "8" \
          --loss_func "CE_KL_review_weighted_3,ConsSamples_selection_two_stage_weighted_4_1" \
          --selection_ratio "1.0" \
          --mt "0.9" \
