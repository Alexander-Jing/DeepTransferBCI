...
base_log_path="/data/datasets_Jyt/DeepTransferBCI/logs_backup/Baselines-001-test-e300-b64-debugs/ours_debug_m_cls_process_1-BNCI2014001-4-all-EEGNet-4,2-e300-b64/proposed_57_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-3-params-ablation9-3-visualization_gd/proposed_57_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
    ...
    for ent in "${thre_alpha[@]}"; do
        for los in "${loss_weight_type[@]}"; do
          ...
          python3 $progarm_path \
            ...
            --stride "8" \
            --batch_size_online "8" \
            --loss_func "CE_KL_review_weighted_10_constrastive_visual_PCGrad" \
