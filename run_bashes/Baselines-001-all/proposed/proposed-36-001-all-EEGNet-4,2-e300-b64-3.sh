...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_14.py"
...
python3 $progarm_path \
  ...
  --data_path "./data/" \
  --data_path_MI "None" \
  --log_path "./logs/Baselines-001-test-e300-b64-debugs/ours_debug_m_cls_process_1-BNCI2014001-4-all-EEGNet-4,2-e300-b64/proposed_36_BNoff_batch8stride8_CaliE_MDR_lcs_ConsSamples_lambda1_0_lambda2_0_thr0.0_lr0.001/" \
  ...
  --stride "8" \
  --batch_size_online "8" \
  --loss_func "CaliE_MDR_lcs_ConsSamples" \
