...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_34.py"

# Set the PYTHONPATH environment variable
export PYTHONPATH="${PYTHONPATH}:$(pwd)"

# Define the parameter values to iterate over
confidence_thresholds=(0.40 0.45 0.60 0.75)
entropy_thresholds=(0.25 0.40 0.55)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-001-test-e300-b64-debugs/ours_debug_m_cls_process_1-BNCI2014001-4-all-EEGNet-4,2-e300-b64/proposed_55_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-5-params/proposed_55_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
...
for conf in "${confidence_thresholds[@]}"; do
    for ent in "${entropy_thresholds[@]}"; do
        ...
        python3 $progarm_path \
          ...
          --stride "8" \
          --batch_size_online "8" \
          --loss_func "CE_KL_review_weighted_6,ConsSamples_selection_two_stage_weighted_4_1_review_4_1" \
          ...
          --memory_type "DropMemoryBank_review_2" \
