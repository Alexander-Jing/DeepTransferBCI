...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_52.py"
...
thre_alpha=(0.0002 0.0001)
loss_weight_type=(10.0)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-001-test-e300-b64-debugs/ours_debug_m_cls_process_1-BNCI2014001-4-all-EEGNet-4,2-e300-b64-new/proposed_57_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-3-params-ablation12-3-new/proposed_57_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
    ...
    for ent in "${thre_alpha[@]}"; do
        for los in "${loss_weight_type[@]}"; do
          ...
          python3 $progarm_path \
            ...
            --stride "8" \
            --batch_size_online "8" \
            --loss_func "ablation12,ablation12" \
