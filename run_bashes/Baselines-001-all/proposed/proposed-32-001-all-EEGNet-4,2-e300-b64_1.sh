...
python3 $progarm_path \
  ...
  --data_path "./data/" \
  --data_path_MI "None" \
  --log_path "./logs/Baselines-001-test-e300-b64-debugs/ours_debug_m_cls_process_1-BNCI2014001-4-all-EEGNet-4,2-e300-b64/proposed_31_BNoff_batch8stride8_PresudoLabelEMA_symmetric_lambda_2_0_lr0.001/" \
  ...
  --stride "8" \
  --batch_size_online "8" \
  --loss_func "PresudoLabelEMA_symmetric" \
