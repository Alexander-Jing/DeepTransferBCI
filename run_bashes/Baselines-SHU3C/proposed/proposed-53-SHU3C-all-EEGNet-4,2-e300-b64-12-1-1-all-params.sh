...
base_log_path="./logs/Baselines-WBCIC-SHU-3C-e300-b64/proposed/proposed_53_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-12-1-1-params/proposed_53_BNoff_batch8stride8_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
...
for conf in "${confidence_thresholds[@]}"; do
    for ent in "${entropy_thresholds[@]}"; do
        ...
        python3 $progarm_path \
          ...
          --memory_type "DropMemoryBank_review" \
