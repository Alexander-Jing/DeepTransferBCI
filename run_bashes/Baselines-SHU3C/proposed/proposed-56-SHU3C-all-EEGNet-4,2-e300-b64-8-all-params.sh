...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_39.py"
...
thre_alpha=(1.0 1.5)
loss_weight_type=(10.0 2.0 20.0)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-WBCIC-SHU-3C-e300-b64/proposed/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-8-params/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
