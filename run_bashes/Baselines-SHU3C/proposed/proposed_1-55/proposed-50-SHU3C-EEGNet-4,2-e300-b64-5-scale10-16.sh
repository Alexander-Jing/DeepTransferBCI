...
python3 $progarm_path \
  ...
  --log_path "./logs/Baselines-WBCIC-SHU-3C-e300-b64/proposed/proposed_50_BNoff_batch16stride16_CE_KL_lcs_ConsSamples_selection_twoStage_weighted_lr0.001-5-scale10-16/" \
