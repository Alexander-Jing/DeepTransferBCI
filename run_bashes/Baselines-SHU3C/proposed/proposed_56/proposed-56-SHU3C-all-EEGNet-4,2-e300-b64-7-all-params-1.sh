...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_37_1.py"
...
base_log_path="./logs/Baselines-WBCIC-SHU-3C-e300-b64/proposed/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-7-params-1/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
...
for conf in "${confidence_thresholds[@]}"; do
    for ent in "${entropy_thresholds[@]}"; do
        ...
        python3 $progarm_path \
          ...
          --stride "1" \
          --batch_size_online "8" \
          --loss_func "CE_KL_review_weighted_9,ConsSamples_selection_two_stage_weighted_4_1_review_4_4" \
