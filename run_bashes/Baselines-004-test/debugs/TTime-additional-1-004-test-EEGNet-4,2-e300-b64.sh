...
progarm_path="tl/ttime_debug_m_cls_process-no_MDR.py"
...
python3 $progarm_path \
  ...
  --data_path "./data/" \
  --data_path_MI "None" \
  --log_path "./logs/Baselines-004-test-e300-b64/debugs/ttime-additional-no_MDR-BNCI2014_004-test-EEGNet4,2-e300-b64/" \
