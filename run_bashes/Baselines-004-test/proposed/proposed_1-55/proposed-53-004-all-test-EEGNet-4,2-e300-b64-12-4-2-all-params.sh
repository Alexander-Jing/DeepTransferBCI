...
confidence_thresholds=(0.45 0.60 0.75 0.80 0.90 0.95)
entropy_thresholds=(0.25 0.40 0.55)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-004-test-e300-b64/proposed/proposed_53_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-12-4-2-params/proposed_53_BNoff_batch8stride4_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
