...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_45.py"

# Set the PYTHONPATH environment variable
export PYTHONPATH="${PYTHONPATH}:$(pwd)"

# Define the parameter values to iterate over
confidence_thresholds=(0.60 0.65 0.70 0.75 0.80 0.85 0.90)
thre_alpha=(1.0)
loss_weight_type=(20.0)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-004-test-e300-b64/proposed/proposed_57_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-3-params-ablation9/proposed_57_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
    ...
    for ent in "${thre_alpha[@]}"; do
        for los in "${loss_weight_type[@]}"; do
          ...
          python3 $progarm_path \
            ...
            --stride "1" \
            --batch_size_online "8" \
            --loss_func "CE_KL_review_weighted_10_constrastive,ConsSamples_selection_two_stage_weighted_4_1_review_4_4_4" \
