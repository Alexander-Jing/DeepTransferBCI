...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_35.py"
...
base_log_path="./logs/Baselines-004-test-e300-b64/proposed/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-2-params/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
...
for conf in "${confidence_thresholds[@]}"; do
    for ent in "${entropy_thresholds[@]}"; do
        ...
        python3 $progarm_path \
          ...
          --memory_type "DropMemoryBank_review_5" \
          --memory_review "get_memory_review" \
          --weight_type "entropy" \
          --memory_capacity "64" \
