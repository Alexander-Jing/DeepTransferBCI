...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_40.py"

# Set the PYTHONPATH environment variable
export PYTHONPATH="${PYTHONPATH}:$(pwd)"

# Define the parameter values to iterate over
confidence_thresholds=(0.35 0.40 0.45 0.50 0.55)
thre_alpha=(0.5 1.0 1.5 2.0)
loss_weight_type=(10.0)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-004-test-e300-b64/proposed/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-9-params/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
    ...
    for ent in "${thre_alpha[@]}"; do
        for los in "${loss_weight_type[@]}"; do
          ...
          python3 $progarm_path \
            ...
            --stride "1" \
            --batch_size_online "8" \
            --loss_func "CE_KL_review_weighted_9,ConsSamples_selection_two_stage_weighted_4_1_review_4_4_1" \
            ...
            --memory_capacity "64" \
            --thre_alpha "$ent" \
            --loss_weight_type "sigmoid" \
            --gate_type "median" \
            --buffer_selefction_type "entropy" \
