...
progarm_path="tl/proposed_method/ours_debug_m_cls_process_37.py"
...
entropy_thresholds=(0.25 0.40 0.45 0.50 0.55)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-004-test-e300-b64/proposed/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-5-params/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
...
for conf in "${confidence_thresholds[@]}"; do
    for ent in "${entropy_thresholds[@]}"; do
        ...
        python3 $progarm_path \
          ...
          --stride "1" \
          --batch_size_online "8" \
          --loss_func "CE_KL_review_weighted_7,ConsSamples_selection_two_stage_weighted_4_1_review_4_2" \
