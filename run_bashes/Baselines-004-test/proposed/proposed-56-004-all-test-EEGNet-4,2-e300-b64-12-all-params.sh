...
confidence_thresholds=(0.40 0.45 0.50 0.55 0.35)
thre_alpha=(0.5)
loss_weight_type=(10.0)

# Base log path (without the trailing index)
base_log_path="./logs/Baselines-004-test-e300-b64/proposed/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-12-params/proposed_56_BNoff_batch8stride1_CE_KL_review_ConsSamples_selection_two_stage_weighted_4_1_double_lr0.001-p"
    ...
    for ent in "${thre_alpha[@]}"; do
        for los in "${loss_weight_type[@]}"; do
          ...
          python3 $progarm_path \
            ...
            --stride "1" \
            --batch_size_online "8" \
            --loss_func "CE_KL_review_weighted_10,ConsSamples_selection_two_stage_weighted_4_1_review_4_4_2" \
