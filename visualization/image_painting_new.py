...
def generate_combined_confidece_plot(save_dir):
    """
    ...
    # 横轴标签
    tau_labels = ['0.55', '0.60', '0.65', '0.70', '0.75', '0.80']
    # 使用索引作为 X 轴坐标，以实现等间距排列
    x_indexes = np.arange(len(tau_labels))
    
    # 精度数据 (%)
    data_2a = [68.99, 69.04, 69.08, 69.03, 68.97, 68.60]
    data_2b = [79.54, 79.65, 80.01, 79.90, 79.71, 79.60]
    data_shu = [72.87, 72.86, 73.01, 72.83, 72.86, 72.59]
    ...
    # --- 3. 标签与图例 ---
    # 使用 LaTeX 渲染希腊字母 \tau
    ax.set_xlabel(r'Value of base threshold $c_{\tau_0}$', labelpad=20, fontsize=24)
    ...
    file_base = "Combined_Confidence_Threshold_Sensitivity"
...
if __name__ == "__main__":
    ...
    generate_combined_confidece_plot(target_dir)