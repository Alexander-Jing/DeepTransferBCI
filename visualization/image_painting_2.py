...
def generate_combined_tau_plot(save_dir):
    ...
    # 横轴标签
    tau_labels = ['0.10', '0.50', '1.00', '2.00', '3.00', '4.00', '5.00']
    # 使用索引作为 X 轴坐标，以实现等间距排列
    x_indexes = np.arange(len(tau_labels))
    
    # 精度数据 (%)
    data_2a = [67.32, 69.05, 69.21, 69.21, 69.16, 69.14, 69.05]
    data_2b = [78.75, 79.79, 80.00, 80.07, 80.21, 80.26, 80.20]
    data_shu = [70.13, 72.62, 73.02, 73.24, 73.15, 73.05, 73.04]
