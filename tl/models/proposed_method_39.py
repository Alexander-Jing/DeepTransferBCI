...
from tl.utils.memory_proposed_3 import DropMemoryBank_review_2, DropMemoryBank_review_3, DropMemoryBank_review_4, DropMemoryBank_review_5, DropMemoryBank_review_6, DropMemoryBank_review_7, DropMemoryBank_review_8, HUS, CSTU, FIFO
                ...
                if self.paras_optim['name'] == 'Adam':
                    ...
                    if self.updating_type in ["entropy_review"]:    
                        ...
                        if self.memory.get_occupancy() >= int(self.capacity/2):
                            ...
                            elif self.losses[0].strip() in ["CE_KL_review_weighted_9","CE_KL_review_weighted_10", "CE_KL_review_weighted_10_constrastive"]: 
                        ...
                        if self.memory.get_occupancy() >= int(self.capacity/2):
                            ...
                            elif self.losses[1].strip() in ["ConsSamples_selection_two_stage_weighted_4_1_review_4_4","ConsSamples_selection_two_stage_weighted_4_1_review_4_4_1","ConsSamples_selection_two_stage_weighted_4_1_review_4_4_2", "ConsSamples_selection_two_stage_weighted_4_1_review_4_4_3","ConsSamples_selection_two_stage_weighted_4_1_review_4_4_4"]: 
