...
from utils.memory_motta import DropMemoryBank
from utils.loss_motta import NegWeightedMutualInformation_on_marginal
from utils.optimizer_motta import build_optimizer
...
class MoTTA(nn.Module):
    def __init__(self, model, paras_optim, capacity, num_classes, bn_alpha, temp_factor,
                 ...
                 category_uniform=True, record=False, metric_name='pruning_logit_norm_change', update_counter='each', return_type='xy'):
