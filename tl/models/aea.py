...
import tl.utils.adaptation_utils_aea as adaptation_utils
from tl.utils.api_aea import Batch
from tl.utils.base_adaptation_aea import BaseAdaptation
from tl.utils.base_selection_aea import BaseSelection
from tl.utils.metrics_faea import Metrics
from tl.utils.metrics_faea import fork_rng_with_seed
from tl.utils.metrics_faea import Logger
from tl.utils.metrics_faea import Timer
    ...
    def one_adapt_step(
        ...
        if self._meta_conf.loss_name == "em_energy_sp_wlcs":  # AEA
            with fork_rng_with_seed(random_seed):
                _, y_hat = model(batch._x)
                cls_weight = model[1].fc.weight.data.clone()
