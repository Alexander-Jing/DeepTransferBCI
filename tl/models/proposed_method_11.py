...
class proposed_TTA(nn.Module):
    def __init__(self, model, paras_optim, capacity, num_classes, bn_alpha, temp_factor,
        ...
        if loss_name == 'MemorySoftplusEnergyAlignment':
            ...
            self.loss_fn = PresudoLabelMemorySoftplusEnergyAlignment(lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, 
                                                                     lambda_3=1.0, temp=EnergyAlignment.temp)
        elif loss_name == 'MemorySoftplusEnergyWeightedAlignment':
            self.loss_fn = MemorySoftplusEnergyWeightedAlignment(lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, 
                                                                     temp=EnergyAlignment.temp)
        elif loss_name == 'MemorySoftplusEnergyRatioSortedAlignment':
            self.loss_fn = MemorySoftplusEnergyRatioSortedAlignment(lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, 
                                                                     temp=EnergyAlignment.temp)
        elif loss_name == 'MemorySoftplusEnergyFeatureWeightedAlignment':
            self.loss_fn = MemorySoftplusEnergyFeatureWeightedAlignment(lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, 
                                                                     temp=EnergyAlignment.temp)
            ...
            self.loss_fn = CaliE_UKL(lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, temp=EnergyAlignment.temp)
        elif loss_name == 'CE_KL':
            self.loss_fn = CE_KL(lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, temp=EnergyAlignment.temp)
            ...
            self.loss_fn = PresudoLabelEMA(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'PresudoLabelEMA_selection':
            self.loss_fn = PresudoLabelEMA_selection(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'PresudoLabelEMA_energy':
            self.loss_fn = PresudoLabelEMA_energy(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'PresudoLabelEMA_symmetric':
            self.loss_fn = PresudoLabelEMA_symmetric(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'PresudoLabelEMA_lcs':
            self.loss_fn = PresudoLabelEMA_lcs(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'PresudoLabelEMA_SampleCons':
            self.loss_fn = PresudoLabelEMA_SampleCons(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        
        
        elif loss_name == 'EntropyMDREMA_lcs':
            self.loss_fn = EntropyMDREMA_lcs(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CaliE_MDR_lcs':
            self.loss_fn = CaliE_MDR_lcs(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CaliE_MDR_lcs_selection':
            self.loss_fn = CaliE_MDR_lcs_selection(thr=0.4, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CaliE_MDR_lcs_cons':
            self.loss_fn = CaliE_MDR_lcs_cons(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CaliE_MDR_lcs_ConsSamples':
            self.loss_fn = CaliE_MDR_lcs_ConsSamples(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CaliE_MDR_lcs_ConsSamplesFea':
            self.loss_fn = CaliE_MDR_lcs_ConsSamplesFea(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CE_KL_ConsSamplesFea':
            self.loss_fn = CE_KL_ConsSamplesFea(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CE_KL_lcs_ConsSamples':
            self.loss_fn = CE_KL_lcs_ConsSamples(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'CE_KL_lcs_ConsSamples_selection':
            self.loss_fn = CE_KL_lcs_ConsSamples_selection(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        


        elif loss_name == 'ConsSamples_lcs':
            self.loss_fn = ConsSamples_lcs(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'ConsSamples_weighted':
            self.loss_fn = ConsSamples_weighted(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'ConsSamples':
            self.loss_fn = ConsSamples(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'ConsSamples_selection':
            self.loss_fn = ConsSamples_selection(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
        elif loss_name == 'ConsSamples_selection_1':
            self.loss_fn = ConsSamples_selection_1(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
            ...
            self.loss_fn = Weighted_ConsSamples_selection_distillation(ratio=EnergyAlignment.ratio, lambda_1=EnergyAlignment.lambda_1, lambda_2=EnergyAlignment.lambda_2, lambda_3=EnergyAlignment.lambda_3, temp=EnergyAlignment.temp)
