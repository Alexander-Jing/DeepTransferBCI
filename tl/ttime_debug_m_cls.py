...
def TTIME(loader, model, args, balanced=True):
    ...
    if balanced:
        ...
        if args.data_name == 'BNCI2014001-4':
            y_pred = np.array(y_pred).reshape(-1, args.class_num)  # multiclass
        else:
...
if __name__ == '__main__':
    ...
    data_name_list = ['BNCI2014001', 'BNCI2014002', 'BNCI2015001', 'BNCI2014001-4', 'MI-hand_elbow','MI-elbow_rest', 'MI-hand_rest', 'BNCI2014001-4-all', 'BNCI2014001-4-train']
