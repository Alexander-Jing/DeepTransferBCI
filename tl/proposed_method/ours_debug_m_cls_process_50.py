...
from tl.models.proposed_method_44 import proposed_TTA
...
def motta_func(loader, model, args, balanced=True):
    ...
    proposed_TTA_model = proposed_TTA(model=model, paras_optim=args.paras_optim, capacity=args.capacity,num_classes=args.class_num, bn_alpha=args.bn_alpha, temp_factor=1, 
                        ...
                        memory_type=args.memory_type, memory_review=args.memory_review, result_path=str(args.result_dir), sub_information=Box({"idx":str(args.idt), "seed":str(args.SEED)}))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_results', type=str2bool, default=True, help='whether to save results for visulization')
