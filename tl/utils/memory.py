...
class HUS:
    def __init__(self, capacity, class_num, threshold=None):
        self.class_num = class_num
        self.data = [[[], [], [], []] for _ in
                     range(self.class_num)]  # feat, pseudo_cls, domain, conf
        self.counter = [0] * self.class_num
        self.marker = [''] * self.class_num
        self.capacity = capacity
    ...
    def print_real_class_dist(self):
        occupancy_per_class = [0] * self.class_num
    ...
    def reset_value(self, feats, cls, aux):
        self.data = [[[], [], [], []] for _ in range(self.class_num)]  # feat, pseudo_cls, domain, conf
