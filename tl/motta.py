...
from models.motta import MoTTA
...
def motta_func(loader, model, args, balanced=True):
    ...
    motta_model = MoTTA(model=model, paras_optim=args.paras_optim, capacity=args.capacity,num_classes=args.class_num, bn_alpha=args.bn_alpha, temp_factor=1, 
