...
def dataset_to_file(dataset_name, data_save, data_path='./data/', proxy=None, timeout=60, retries=5):
    ...
    if data_save:
        ...
        X, labels, meta = paradigm.get_data(dataset=dataset, subjects=[dataset.subject_list[5]])
        ...
        sio.savemat(data_path + dataset_name + '/data004_sub05_debug.mat', {'X': X, 'labels': labels})
        print('done!')
    else:
